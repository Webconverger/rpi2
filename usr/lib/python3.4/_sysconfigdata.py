...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'CONFIG_ARGS': "'--prefix=/usr' '--enable-shared' '--with-threads' "
                ...
                "'CFLAGS=-march=armv7-a -mfloat-abi=hard -mfpu=vfpv3-d16 -O2 "
                "-pipe -fstack-protector --param=ssp-buffer-size=4' "
 ...
 'COVERAGE_INFO': '/build/python/src/Python-3.4.3/coverage.info',
 'COVERAGE_REPORT': '/build/python/src/Python-3.4.3/lcov-report',
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -DNDEBUG -g -fwrapv -O3 -Wall '
                   '-Wstrict-prototypes -march=armv7-a -mfloat-abi=hard '
                   '-mfpu=vfpv3-d16 -O2 -pipe -fstack-protector '
                   '--param=ssp-buffer-size=4 -march=armv7-a '
                   '-mfloat-abi=hard -mfpu=vfpv3-d16 -O2 -pipe '
                   '-fstack-protector --param=ssp-buffer-size=4 '
                   '-Werror=declaration-after-statement -I. -IInclude '
                   '-I./Include -D_FORTIFY_SOURCE=2 -D_FORTIFY_SOURCE=2 '
                   '-fPIC -DPy_BUILD_CORE',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/build/python/src/Python-3.4.3',
 'SCRIPTDIR': '/usr/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/build/python/src/Python-3.4.3 ./python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/build/python/src/Python-3.4.3 ./python '
 ...
 'abs_builddir': '/build/python/src/Python-3.4.3',
 'abs_srcdir': '/build/python/src/Python-3.4.3',
