...
cf_by='builduser'
cf_email=''
cf_time='Tue Feb 17 03:32:57 MST 2015'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
incpath=''
incpth='/usr/lib/gcc/armv7l-unknown-linux-gnueabihf/4.9.2/include /usr/local/include /usr/lib/gcc/armv7l-unknown-linux-gnueabihf/4.9.2/include-fixed /usr/include'
inews=''
...
libspath=' /usr/local/lib /usr/lib/gcc/armv7l-unknown-linux-gnueabihf/4.9.2/include-fixed /usr/lib /lib'
...
mydomain='.nonet'
myhostname='leming'
myuname='linux leming 3.10.63-6-arch #1 smp preempt mon jan 26 20:07:35 mst 2015 armv7l gnulinux '
n='-n'
need_va_copy='undef'
...
phostname='uname -n'
pidtype='pid_t'
plibpth='/lib/armv7l-unknown-linux-gnueabihf/4.9.2 /lib /usr/lib/armv7l-unknown-linux-gnueabihf/4.9.2 /usr/lib'
pmake=''
pr=''
prefix='/usr'
prefixexp='/usr'
